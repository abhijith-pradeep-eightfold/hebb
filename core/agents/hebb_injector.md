...
- **Manual invocation, manual PR.** You are invoked by a human, never auto-triggered by the SE agent; and you open a PR only when explicitly asked. But you can commit and push, to a new branch.
